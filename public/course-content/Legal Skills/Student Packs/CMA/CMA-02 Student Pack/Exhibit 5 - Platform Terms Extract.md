# Exhibit 5 - Platform Terms Extract

Source path: `Legal Skills/Student Packs/CMA/CMA-02 Student Pack/Exhibit 5 - Platform Terms Extract.docx`
...
| 👤 | Exhibit number | 5 |
| ◷ | Document title | Platform Terms Extract |
...
| Document | Exchange and escrow terms |
| --- | --- |
| Status | Relevant extract |


Transactions are final once smart contract execution is complete, except where fraud, manifest error or binding dispute decision requires remedial action. Disputes are subject to the agreed dispute process stated in the transaction confirmation.


| Check item | Evidence in exhibit | Student note |
| --- | --- | --- |
| What counts as manifest error? |  |  |
| What dispute process applies? |  |  |
| Can fraud be evidenced? |  |  |
...
| --- | --- | --- | --- |
| 1 | Status \| Relevant extract | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | Transactions are final once smart contract execution is complete, except where fraud, manifest error or binding dispute decision requires remedial action. Disputes are subject to the agreed dispute process stated in the | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 3 | What counts as manifest error? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 4 | What dispute process applies? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 5 | Can fraud be evidenced? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
