...
**Exhibit 1 - Supervisor Instruction Email**

**What This Exhibit Contains**

This exhibit contains the source material for 'Supervisor Instruction Email'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: From \| Commercial Partner To \| Student Purpose \| Drafting review
...
| To       | Student            |
| Purpose  | Drafting review    |

Our client, HarborPay, is acquiring hosted payment processing services. The supplier draft is very supplier-friendly. Please redraft the clauses so the client has a meaningful remedy for serious downtime, data loss and repeated failures, while keeping the drafting realistic for negotiation.
...
> **•** Narrative point: Our client, HarborPay, is acquiring hosted payment processing services. The supplier draft is very supplier-friendly. Please redraft the clauses so the client has a meaningful remedy for serious downtime, data loss and repeated failures, while keeping the...
>
> **•** Source detail: Date is recorded as 7 November.
>
> **•** Source detail: From is recorded as Commercial Partner.
>
> **•** Source detail: To is recorded as Student.
>
> **•** Source detail: Purpose is recorded as Drafting review.
