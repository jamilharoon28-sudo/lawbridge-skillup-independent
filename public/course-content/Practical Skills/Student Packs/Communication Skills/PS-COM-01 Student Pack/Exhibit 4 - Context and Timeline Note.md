...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Founder asks practical data-use question | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Clause restricts project materials after termination | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Previous draft uses jargon | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Company wants to reuse anonymised learnings | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Must identify legal verification points | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Founder asks practical data-use question; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Clause restricts project materials after termination; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Previous draft uses jargon; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Company wants to reuse anonymised learnings; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Must identify legal verification points; Why timing matters: Consider whether timing affects priority or escalation..
