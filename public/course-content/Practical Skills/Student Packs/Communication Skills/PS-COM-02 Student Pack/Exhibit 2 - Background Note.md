...
|-------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Client / matter setting             | Priya learns that an important document was not signed before the deadline. The team must explain the issue, next steps and uncertainty without panic or defensiveness. |
...
**Client asks if deal is at risk**

**Signature page appears unsigned**

**Late completion may be accepted but not confirmed**

**Deadline passed yesterday 5pm**

**Follow-up call tomorrow**

**Supervisor says do not speculate**

| **\#** | **File point**                                    | **How to treat it**                      | **Follow-up required**                              |
|--------|---------------------------------------------------|------------------------------------------|-----------------------------------------------------|
| 1      | Client asks if deal is at risk                    | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2      | Signature page appears unsigned                   | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3      | Late completion may be accepted but not confirmed | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4      | Deadline passed yesterday 5pm                     | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5      | Follow-up call tomorrow                           | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6      | Supervisor says do not speculate                  | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
>
> **•** Source detail: Client / matter setting is recorded as Priya learns that an important document was not signed before the deadline. The team must explain the issue, next steps and uncertainty without panic or defensiveness..
>
...
>
> **•** For \# '1', the exhibit records File point: Client asks if deal is at risk; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '2', the exhibit records File point: Signature page appears unsigned; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '3', the exhibit records File point: Late completion may be accepted but not confirmed; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '4', the exhibit records File point: Deadline passed yesterday 5pm; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '5', the exhibit records File point: Follow-up call tomorrow; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '6', the exhibit records File point: Supervisor says do not speculate; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
