...
| To              | Student                                                        |
| Subject         | PS-COM-01 - Explaining a Complex Issue to a Non-Lawyer Founder |
| Priority        | Medium to high - prepare a practical trainee-style output      |

**Email body**

Please review the attached training file for Explaining a Complex Issue to a Non-Lawyer Founder. The client or internal team needs a practical output, not an academic essay. Do not assume facts that are not in the exhibits. Do not give a final legal conclusion where the applicable framework or source has not been verified. Your task is to identify the core issue, extract the evidence, flag uncertainty, and produce a clear next step.

Primary skill focus: Communication Skills.

Matter type: Plain English legal communication.

Core scenario: Tomas, a founder, is confused by a long email about whether a contract clause stops the company using its own data later. He needs a plain English explanation.
...
> **•** Narrative point: Please review the attached training file for Explaining a Complex Issue to a Non-Lawyer Founder. The client or internal team needs a practical output, not an academic essay. Do not assume facts that are not in the exhibits. Do not give a final legal...
>
> **•** Narrative point: Primary skill focus: Communication Skills.
>
> **•** Narrative point: Matter type: Plain English legal communication.
>
> **•** Narrative point: Core scenario: Tomas, a founder, is confused by a long email about whether a contract clause stops the company using its own data later. He needs a plain English explanation.
>
...
>
> **•** Source detail: Subject is recorded as PS-COM-01 - Explaining a Complex Issue to a Non-Lawyer Founder.
>
