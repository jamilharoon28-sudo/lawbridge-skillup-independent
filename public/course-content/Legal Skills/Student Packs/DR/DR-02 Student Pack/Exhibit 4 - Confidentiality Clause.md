# Exhibit 4 - Confidentiality Clause

Source path: `Legal Skills/Student Packs/DR/DR-02 Student Pack/Exhibit 4 - Confidentiality Clause.docx`

### Exhibit 4 - Confidentiality Clause


Student Exhibit Document | Reviewing a Settlement Pack Before Signature
...
| 👤 | Exhibit number | 4 |
| ◷ | Document title | Confidentiality Clause |
...
This exhibit contains the source material for 'Confidentiality Clause'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Client must not discuss the settlement with anyone except professional advisers.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Confidentiality Clause'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Client must not discuss the settlement with anyone except professional advisers. |
...
Client must not discuss the settlement with anyone except professional advisers.
...
| --- | --- | --- | --- |
| 1 | Client must not discuss the settlement with anyone except professional advisers. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
