...
|----------------|-----------------------------------------|---------------------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Client asks if deal is at risk                    | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Signature page appears unsigned                   | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Late completion may be accepted but not confirmed | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Deadline passed yesterday 5pm                     | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Follow-up call tomorrow                           | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Client asks if deal is at risk; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Signature page appears unsigned; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Late completion may be accepted but not confirmed; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Deadline passed yesterday 5pm; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Follow-up call tomorrow; Why timing matters: Consider whether timing affects priority or escalation..
