# Exhibit 5 - Terms Extract

Source path: `Legal Skills/Student Packs/AO/AO-01 Student Pack/Exhibit 5 - Terms Extract.docx`
...
This exhibit contains the source material for 'Terms Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Status | Extract only The supplier will make the module available through the customer dashboard. The customer is responsible for assigning authorised users. The supplier will provide reasonable onboarding support for new modules during the first 14 days. What does 'make available' mean practically?
...
| Document | SaaS Module Terms |
| --- | --- |
| Status | Extract only |


The supplier will make the module available through the customer dashboard. The customer is responsible for assigning authorised users. The supplier will provide reasonable onboarding support for new modules during the first 14 days.


| Check item | Evidence in exhibit | Student note |
| --- | --- | --- |
| What does 'make available' mean practically? |  |  |
| Does onboarding support assist the buyer? |  |  |
| Is reasonable support evidenced? |  |  |
...
| --- | --- | --- | --- |
| 1 | Status \| Extract only | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | The supplier will make the module available through the customer dashboard. The customer is responsible for assigning authorised users. The supplier will provide reasonable onboarding support for new modules during the f | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 3 | What does 'make available' mean practically? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 4 | Does onboarding support assist the buyer? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 5 | Is reasonable support evidenced? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
