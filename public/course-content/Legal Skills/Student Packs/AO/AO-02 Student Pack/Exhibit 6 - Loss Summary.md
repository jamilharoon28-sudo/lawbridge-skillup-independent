# Exhibit 6 - Loss Summary

Source path: `Legal Skills/Student Packs/AO/AO-02 Student Pack/Exhibit 6 - Loss Summary.docx`
...
This exhibit contains the source material for 'Loss Summary'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Status | Draft estimate Lost online sales | 640,000 | Forecast basis Extra staffing | 42,000 | Timesheets available
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Loss Summary'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Status \| Draft estimate Lost online sales \| 640,000 \| Forecast basis Extra staffing \| 42,000 \| Timesheets available |
...
| Loss category | Estimate | Evidence issue |
| --- | --- | --- |
| Lost online sales | 640,000 | Forecast basis |
| Extra staffing | 42,000 | Timesheets available |
| Forensic costs | 75,000 | Invoices available |
| Brand campaign | 110,000 | May be mitigation/reputation mixed |
...
| --- | --- | --- | --- |
| 1 | Status \| Draft estimate | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | Lost online sales \| 640,000 \| Forecast basis | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 3 | Extra staffing \| 42,000 \| Timesheets available | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 4 | Forensic costs \| 75,000 \| Invoices available | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 5 | Brand campaign \| 110,000 \| May be mitigation/reputation mixed | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
