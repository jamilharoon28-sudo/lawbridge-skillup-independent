...
- Narrative point: Please review the attached training file for Giving a Clear Update After Bad News. The client or internal team needs a practical output, not an academic essay. Do not assume facts that are not in the exhibits. Do not give a final legal conclusion where the...

- Narrative point: Primary skill focus: Communication Skills.

- Narrative point: Matter type: Client update and tone management.

- Narrative point: Core scenario: Priya learns that an important document was not signed before the deadline. The team must explain the issue, next steps and uncertainty without panic or defensiveness.
...
- Source detail: Subject is recorded as PS-COM-02 - Giving a Clear Update After Bad News.
