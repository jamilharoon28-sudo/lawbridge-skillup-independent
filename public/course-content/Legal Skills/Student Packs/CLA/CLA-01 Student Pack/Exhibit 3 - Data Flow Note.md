# Exhibit 3 - Data Flow Note

Source path: `Legal Skills/Student Packs/CLA/CLA-01 Student Pack/Exhibit 3 - Data Flow Note.docx`
...
This exhibit contains the source material for 'Data Flow Note'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Data includes purchase history, location category and loyalty status. Direct identifiers should be removed before transfer.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Data Flow Note'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Data includes purchase history, location category and loyalty status. Direct identifiers should be removed before transfer. |
...
Data includes purchase history, location category and loyalty status. Direct identifiers should be removed before transfer.
...
| --- | --- | --- | --- |
| 1 | Data includes purchase history, location category and loyalty status. Direct identifiers should be removed before transfer. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
