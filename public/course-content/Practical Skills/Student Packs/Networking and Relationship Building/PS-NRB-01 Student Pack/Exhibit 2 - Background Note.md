...
**Client / matter setting:** After a panel event, a student wants to follow up with a speaker. The message must be professional, specific and not demanding.
...
## Specific event reference matters

| # | File point | How to treat it | Follow-up required |
| --- | --- | --- | --- |
| 1 | Speaker discussed retail work to legal operations | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2 | Student is first-generation and nervous | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3 | Draft asks for referral | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4 | Speaker is legal operations manager active in mentoring | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5 | Networking is learning not instant favours | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6 | Specific event reference matters | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
- Source detail: Client / matter setting is recorded as After a panel event, a student wants to follow up with a speaker. The message must be professional, specific and not demanding..
...
- For # '1', the exhibit records File point: Speaker discussed retail work to legal operations; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '2', the exhibit records File point: Student is first-generation and nervous; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '3', the exhibit records File point: Draft asks for referral; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '4', the exhibit records File point: Speaker is legal operations manager active in mentoring; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '5', the exhibit records File point: Networking is learning not instant favours; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '6', the exhibit records File point: Specific event reference matters; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
