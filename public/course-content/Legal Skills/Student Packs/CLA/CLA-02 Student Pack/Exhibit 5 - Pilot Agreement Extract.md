# Exhibit 5 - Pilot Agreement Extract

Source path: `Legal Skills/Student Packs/CLA/CLA-02 Student Pack/Exhibit 5 - Pilot Agreement Extract.docx`

### Exhibit 5 - Pilot Agreement Extract


Student Exhibit Document | Advising on a Failed FinTech Pilot
...
| 👤 | Exhibit number | 5 |
| ◷ | Document title | Pilot Agreement Extract |
...
This exhibit contains the source material for 'Pilot Agreement Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Extension requires written approval. Service levels are described as pilot targets, not guarantees.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Pilot Agreement Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Extension requires written approval. Service levels are described as pilot targets, not guarantees. |
...
Extension requires written approval. Service levels are described as pilot targets, not guarantees.
...
| --- | --- | --- | --- |
| 1 | Extension requires written approval. Service levels are described as pilot targets, not guarantees. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
