# Exhibit 6 - Customer Trust Note

Source path: `Legal Skills/Student Packs/CLA/CLA-01 Student Pack/Exhibit 6 - Customer Trust Note.docx`
...
| 👤 | Exhibit number | 6 |
| ◷ | Document title | Customer Trust Note |
...
This exhibit contains the source material for 'Customer Trust Note'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Recent press criticism has focused on retailers using customer data without clear explanations.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Customer Trust Note'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Recent press criticism has focused on retailers using customer data without clear explanations. |
...
Recent press criticism has focused on retailers using customer data without clear explanations.
...
| --- | --- | --- | --- |
| 1 | Recent press criticism has focused on retailers using customer data without clear explanations. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
