...
|----------------|-----------------------------------------|----------------------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Lawyer suggested reading about in-house legal work | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Student attended LawBridge webinar                 | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Draft asks for monthly calls                       | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Lawyer posts occasionally                          | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | No reply for ten days                              | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Lawyer suggested reading about in-house legal work; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Student attended LawBridge webinar; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Draft asks for monthly calls; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Lawyer posts occasionally; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: No reply for ten days; Why timing matters: Consider whether timing affects priority or escalation..
