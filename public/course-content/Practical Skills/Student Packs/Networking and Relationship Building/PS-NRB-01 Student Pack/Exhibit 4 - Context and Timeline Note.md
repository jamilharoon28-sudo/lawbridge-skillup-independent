...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Speaker discussed retail work to legal operations | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Student is first-generation and nervous | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Draft asks for referral | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Speaker is legal operations manager active in mentoring | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Networking is learning not instant favours | Consider whether timing affects priority or escalation. |

## Timing and Dependency Notes

Some tasks can be started immediately even where facts are incomplete.

Students should identify what must be checked before finalising, not wait silently.

Where the file includes a deadline or relationship pressure, communicate early.
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Speaker discussed retail work to legal operations; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Student is first-generation and nervous; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Draft asks for referral; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Speaker is legal operations manager active in mentoring; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Networking is learning not instant favours; Why timing matters: Consider whether timing affects priority or escalation..
