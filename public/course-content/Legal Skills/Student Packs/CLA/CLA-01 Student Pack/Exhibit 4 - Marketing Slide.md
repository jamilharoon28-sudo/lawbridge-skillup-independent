# Exhibit 4 - Marketing Slide

Source path: `Legal Skills/Student Packs/CLA/CLA-01 Student Pack/Exhibit 4 - Marketing Slide.docx`
...
| 👤 | Exhibit number | 4 |
| ◷ | Document title | Marketing Slide |
...
This exhibit contains the source material for 'Marketing Slide'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Marketing expects a 12% uplift but has not tested opt-out wording.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Marketing Slide'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Marketing expects a 12% uplift but has not tested opt-out wording. |
...
Marketing expects a 12% uplift but has not tested opt-out wording.
...
| --- | --- | --- | --- |
| 1 | Marketing expects a 12% uplift but has not tested opt-out wording. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
