# Exhibit 4 - Sales Impact Summary

Source path: `Legal Skills/Student Packs/NP/NP-02 Student Pack/Exhibit 4 - Sales Impact Summary.docx`

### Exhibit 4 - Sales Impact Summary


Student Exhibit Document | Preparing to Settle a Supplier Delay Dispute
...
| 👤 | Exhibit number | 4 |
| ◷ | Document title | Sales Impact Summary |
...
This exhibit contains the source material for 'Sales Impact Summary'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Client estimates £38,000 lost gross sales, but promotion and weather may also have affected demand.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Sales Impact Summary'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Client estimates £38,000 lost gross sales, but promotion and weather may also have affected demand. |
...
Client estimates £38,000 lost gross sales, but promotion and weather may also have affected demand.
...
| --- | --- | --- | --- |
| 1 | Client estimates £38,000 lost gross sales, but promotion and weather may also have affected demand. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
