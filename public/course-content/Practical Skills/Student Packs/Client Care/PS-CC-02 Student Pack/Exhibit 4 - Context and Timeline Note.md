...
|----------------|-----------------------------------------|---------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Missed call due to wrong phone number | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Client lost time from work            | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Case diary shows no successful call   | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Contact preferences need confirming   | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Call plan must rebuild trust          | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Missed call due to wrong phone number; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Client lost time from work; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Case diary shows no successful call; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Contact preferences need confirming; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Call plan must rebuild trust; Why timing matters: Consider whether timing affects priority or escalation..
