...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Settlement figure shared in wrong chat | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | External consultant may have seen it | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Message deleted after 90 seconds | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Screenshots unknown | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Must escalate candidly | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Settlement figure shared in wrong chat; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: External consultant may have seen it; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Message deleted after 90 seconds; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Screenshots unknown; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Must escalate candidly; Why timing matters: Consider whether timing affects priority or escalation..
