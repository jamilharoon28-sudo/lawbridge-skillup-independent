# Exhibit 2 - Partnership Summary

Source path: `Legal Skills/Student Packs/CLA/CLA-01 Student Pack/Exhibit 2 - Partnership Summary.docx`

### Exhibit 2 - Partnership Summary


Student Exhibit Document | Assessing a Retail Data Partnership
...
| 👤 | Exhibit number | 2 |
| ◷ | Document title | Partnership Summary |
...
This exhibit contains the source material for 'Partnership Summary'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Partner will analyse loyalty trends and send targeted offers through the app.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Partnership Summary'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Partner will analyse loyalty trends and send targeted offers through the app. |
...
Partner will analyse loyalty trends and send targeted offers through the app.
...
| --- | --- | --- | --- |
| 1 | Partner will analyse loyalty trends and send targeted offers through the app. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
