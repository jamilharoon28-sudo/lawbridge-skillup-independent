...
Source path: `Legal Skills/Student Packs/LD/LD-02 Student Pack/Exhibit 3 - AI Tool Terms Extract.docx`
...
| 👤 | Exhibit number | 3 |
| ◷ | Document title | AI Tool Terms Extract |
...
| --- | --- | --- | --- |
| 1 | Status \| Extract supplied by design team | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | The user may use outputs generated through the tool subject to these terms. The provider does not guarantee that outputs are unique. The user is responsible for inputs, prompts, review and publication decisions. The prov | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
