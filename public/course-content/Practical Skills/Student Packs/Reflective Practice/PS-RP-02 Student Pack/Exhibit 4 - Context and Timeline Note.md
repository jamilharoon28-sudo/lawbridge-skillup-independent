...
|----------------|-----------------------------------------|------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Wrong client name in paragraph     | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Old matter used as style reference | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Supervisor asks check copied text  | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Draft due internally in one hour   | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Student fears reputation damage    | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Wrong client name in paragraph; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Old matter used as style reference; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Supervisor asks check copied text; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Draft due internally in one hour; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Student fears reputation damage; Why timing matters: Consider whether timing affects priority or escalation..
