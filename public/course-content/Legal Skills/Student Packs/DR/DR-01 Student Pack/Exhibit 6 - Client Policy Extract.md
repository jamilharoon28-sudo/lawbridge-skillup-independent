# Exhibit 6 - Client Policy Extract

Source path: `Legal Skills/Student Packs/DR/DR-01 Student Pack/Exhibit 6 - Client Policy Extract.docx`
...
| 👤 | Exhibit number | 6 |
| ◷ | Document title | Client Policy Extract |
...
This exhibit contains the source material for 'Client Policy Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Client policy requires human review before AI output is used in decision-making.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Client Policy Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Client policy requires human review before AI output is used in decision-making. |
...
Client policy requires human review before AI output is used in decision-making.
...
| --- | --- | --- | --- |
| 1 | Client policy requires human review before AI output is used in decision-making. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
