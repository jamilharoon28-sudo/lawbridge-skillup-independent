...
|----------------|-----------------------------------------|-----------------------------------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Quick review is unclear                                         | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | 12 files include contracts data terms funding terms lease notes | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Client has limited funds                                        | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Only two hours available                                        | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Draft response overpromises                                     | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Quick review is unclear; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: 12 files include contracts data terms funding terms lease notes; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Client has limited funds; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Only two hours available; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Draft response overpromises; Why timing matters: Consider whether timing affects priority or escalation..
