# Exhibit 6 - Decision-Maker Questions

Source path: `Legal Skills/Student Packs/AO/AO-01 Student Pack/Exhibit 6 - Decision-Maker Questions.docx`
...
| 👤 | Exhibit number | 6 |
| ◷ | Document title | Decision-Maker Questions |
...
This exhibit contains the source material for 'Decision-Maker Questions'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Status | Practice prompts Was the module technically activated? | Acknowledges supplier evidence What remedy do you seek today? | Focuses outcome
...
| --- | --- |
| Status | Practice prompts |


| Likely question | Why it matters | Student answer notes |
| --- | --- | --- |
| Was the module technically activated? | Acknowledges supplier evidence |  |
| What remedy do you seek today? | Focuses outcome |  |
| Could your client’s settings be the problem? | Tests weakness |  |
| What evidence shows non-usability? | Forces document reference |  |
...
| --- | --- | --- | --- |
| 1 | Status \| Practice prompts | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | Was the module technically activated? \| Acknowledges supplier evidence | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 3 | What remedy do you seek today? \| Focuses outcome | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 4 | Could your client’s settings be the problem? \| Tests weakness | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 5 | What evidence shows non-usability? \| Forces document reference | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
