...
|-------------------------------------|-------------------------------------------------------------------------------------------------------------------------------|
| Client / matter setting             | A student sends an internal draft with the wrong client name in one paragraph. The error is caught before it leaves the team. |
...
**Wrong client name in paragraph**

**Old matter used as style reference**

**Supervisor asks check copied text**

**Draft due internally in one hour**

**Student fears reputation damage**

**Pre-send checklist needed**

| **\#** | **File point**                     | **How to treat it**                      | **Follow-up required**                              |
|--------|------------------------------------|------------------------------------------|-----------------------------------------------------|
| 1      | Wrong client name in paragraph     | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2      | Old matter used as style reference | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3      | Supervisor asks check copied text  | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4      | Draft due internally in one hour   | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5      | Student fears reputation damage    | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6      | Pre-send checklist needed          | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
>
> **•** Source detail: Client / matter setting is recorded as A student sends an internal draft with the wrong client name in one paragraph. The error is caught before it leaves the team..
>
...
>
> **•** For \# '1', the exhibit records File point: Wrong client name in paragraph; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '2', the exhibit records File point: Old matter used as style reference; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '3', the exhibit records File point: Supervisor asks check copied text; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '4', the exhibit records File point: Draft due internally in one hour; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '5', the exhibit records File point: Student fears reputation damage; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '6', the exhibit records File point: Pre-send checklist needed; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
