# Exhibit 3 - Current Agreement Extract

Source path: `Legal Skills/Student Packs/NP/NP-01 Student Pack/Exhibit 3 - Current Agreement Extract.docx`

### Exhibit 3 - Current Agreement Extract


Student Exhibit Document | Preparing for a SaaS Renewal Negotiation
...
| 👤 | Exhibit number | 3 |
| ◷ | Document title | Current Agreement Extract |
...
This exhibit contains the source material for 'Current Agreement Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Current term is one year. Service credits apply after serious downtime. Liability cap equals annual fees.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Current Agreement Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Current term is one year. Service credits apply after serious downtime. Liability cap equals annual fees. |
...
Current term is one year. Service credits apply after serious downtime. Liability cap equals annual fees.
...
| --- | --- | --- | --- |
| 1 | Current term is one year. Service credits apply after serious downtime. Liability cap equals annual fees. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
