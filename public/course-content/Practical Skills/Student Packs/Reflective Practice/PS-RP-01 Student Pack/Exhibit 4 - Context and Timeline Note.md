...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Good research but answer hidden | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Original opening is vague and complex | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Client asks can payment be paused | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Five long sentences highlighted | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Student feels embarrassed | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Good research but answer hidden; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Original opening is vague and complex; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Client asks can payment be paused; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Five long sentences highlighted; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Student feels embarrassed; Why timing matters: Consider whether timing affects priority or escalation..
