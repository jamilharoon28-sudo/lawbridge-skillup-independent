...
|----------------|-----------------------------------------|------------------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Office Tuesday and Thursday                    | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Student shares accommodation and kitchen table | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Client call at 8:30 due to time zones          | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Two tasks due same afternoon                   | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Draft message blames working from home         | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Office Tuesday and Thursday; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Student shares accommodation and kitchen table; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Client call at 8:30 due to time zones; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Two tasks due same afternoon; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Draft message blames working from home; Why timing matters: Consider whether timing affects priority or escalation..
