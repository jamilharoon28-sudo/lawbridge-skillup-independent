...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Board meeting starts 9am tomorrow | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Two-page risk summary due by 6pm | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Research note due tomorrow noon | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Document review due today 5pm | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Supervisor asked for early warning | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Board meeting starts 9am tomorrow; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Two-page risk summary due by 6pm; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Research note due tomorrow noon; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Document review due today 5pm; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Supervisor asked for early warning; Why timing matters: Consider whether timing affects priority or escalation..
