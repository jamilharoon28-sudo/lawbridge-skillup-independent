...
|-------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| Client / matter setting             | The student has exchanged messages with a junior lawyer twice and wants to stay in touch without appearing transactional. |
...
**Lawyer suggested reading about in-house legal work**

**Student attended LawBridge webinar**

**Draft asks for monthly calls**

**Lawyer posts occasionally**

**No reply for ten days**

**Relationship building over time**

| **\#** | **File point**                                     | **How to treat it**                      | **Follow-up required**                              |
|--------|----------------------------------------------------|------------------------------------------|-----------------------------------------------------|
| 1      | Lawyer suggested reading about in-house legal work | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2      | Student attended LawBridge webinar                 | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3      | Draft asks for monthly calls                       | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4      | Lawyer posts occasionally                          | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5      | No reply for ten days                              | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6      | Relationship building over time                    | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
>
> **•** Source detail: Client / matter setting is recorded as The student has exchanged messages with a junior lawyer twice and wants to stay in touch without appearing transactional..
>
...
>
> **•** For \# '1', the exhibit records File point: Lawyer suggested reading about in-house legal work; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '2', the exhibit records File point: Student attended LawBridge webinar; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '3', the exhibit records File point: Draft asks for monthly calls; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '4', the exhibit records File point: Lawyer posts occasionally; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '5', the exhibit records File point: No reply for ten days; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '6', the exhibit records File point: Relationship building over time; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
