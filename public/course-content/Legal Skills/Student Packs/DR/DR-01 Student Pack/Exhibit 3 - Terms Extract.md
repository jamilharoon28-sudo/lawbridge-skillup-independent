# Exhibit 3 - Terms Extract

Source path: `Legal Skills/Student Packs/DR/DR-01 Student Pack/Exhibit 3 - Terms Extract.docx`
...
This exhibit contains the source material for 'Terms Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Supplier may use usage data and outputs to improve services unless client opts out.
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Terms Extract'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Supplier may use usage data and outputs to improve services unless client opts out. |
...
Supplier may use usage data and outputs to improve services unless client opts out.
...
| --- | --- | --- | --- |
| 1 | Supplier may use usage data and outputs to improve services unless client opts out. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
