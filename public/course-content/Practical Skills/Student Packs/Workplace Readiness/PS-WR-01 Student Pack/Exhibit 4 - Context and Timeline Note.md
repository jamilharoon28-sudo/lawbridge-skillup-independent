...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Start 9:30 bring laptop if available | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Shadow commercial team | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | May sit near client files | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Draft question sounds entitled | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Review bundle for missing signatures | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Start 9:30 bring laptop if available; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Shadow commercial team; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: May sit near client files; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Draft question sounds entitled; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Review bundle for missing signatures; Why timing matters: Consider whether timing affects priority or escalation..
