# Exhibit 1 - Hearing Instruction Email

Source path: `Legal Skills/Student Packs/AO/AO-01 Student Pack/Exhibit 1 - Hearing Instruction Email.docx`
...
| 👤 | Exhibit number | 1 |
| ◷ | Document title | Hearing Instruction Email |
...
This exhibit contains the source material for 'Hearing Instruction Email'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: From | Supervising lawyer To | Student Purpose | Advocacy preparation
...
| --- | --- |
| What this exhibit contains | This exhibit contains the source material for 'Hearing Instruction Email'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: From \| Supervising lawyer To \| Student Purpose \| Advocacy preparation |
...
| Date | 15 December |
| --- | --- |
| From | Supervising lawyer |
| To | Student |
| Purpose | Advocacy preparation |


Prepare a five-minute submission for a preliminary dispute meeting. We act for the buyer, CoreMed Analytics. The issue is whether a digital analytics module was delivered in a usable form after payment.
...
| --- | --- | --- | --- |
| 1 | From \| Supervising lawyer | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | To \| Student | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 3 | Purpose \| Advocacy preparation | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 4 | Prepare a five-minute submission for a preliminary dispute meeting. We act for the buyer, CoreMed Analytics. The issue is whether a digital analytics module was delivered in a usable form after payment. | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
