...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Mentor is commercial disputes associate | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Student has no legal work experience | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | 20. minute online session | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Generic question asks everything about law | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Mentorship is guidance not guaranteed support | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Mentor is commercial disputes associate; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Student has no legal work experience; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: 20 minute online session; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Generic question asks everything about law; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Mentorship is guidance not guaranteed support; Why timing matters: Consider whether timing affects priority or escalation..
