...
|----------------|-----------------------------------------|---------------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Partner asks case summary today if possible | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Associate asks formatting by 5pm            | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | Client meeting notes before tomorrow        | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Supervisor gives research no deadline       | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Mentor session in 30 minutes                | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Partner asks case summary today if possible; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Associate asks formatting by 5pm; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Client meeting notes before tomorrow; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Supervisor gives research no deadline; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Mentor session in 30 minutes; Why timing matters: Consider whether timing affects priority or escalation..
