...
|-------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Client / matter setting             | A supervisor says a draft advice email was too long, too technical and did not answer the client question directly. The student must rewrite and reflect constructively. |
...
**Good research but answer hidden**

**Original opening is vague and complex**

**Client asks can payment be paused**

**Five long sentences highlighted**

**Student feels embarrassed**

**Lead with practical point**

| **\#** | **File point**                        | **How to treat it**                      | **Follow-up required**                              |
|--------|---------------------------------------|------------------------------------------|-----------------------------------------------------|
| 1      | Good research but answer hidden       | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2      | Original opening is vague and complex | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3      | Client asks can payment be paused     | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4      | Five long sentences highlighted       | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5      | Student feels embarrassed             | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6      | Lead with practical point             | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
>
> **•** Source detail: Client / matter setting is recorded as A supervisor says a draft advice email was too long, too technical and did not answer the client question directly. The student must rewrite and reflect constructively..
>
...
>
> **•** For \# '1', the exhibit records File point: Good research but answer hidden; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '2', the exhibit records File point: Original opening is vague and complex; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '3', the exhibit records File point: Client asks can payment be paused; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '4', the exhibit records File point: Five long sentences highlighted; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '5', the exhibit records File point: Student feels embarrassed; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
>
> **•** For \# '6', the exhibit records File point: Lead with practical point; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
