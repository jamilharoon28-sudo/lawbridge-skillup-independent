...
|----------------|-----------------------------------------|-----------------------------------------|---------------------------------------------------------|
| Day 1          | Initial instruction received            | Key points needed before 4pm            | Consider whether timing affects priority or escalation. |
| Day 2          | Relevant documents or messages reviewed | Client complaint received               | Consider whether timing affects priority or escalation. |
| Day 3          | Uncertainty identified                  | One deadline uncertain                  | Consider whether timing affects priority or escalation. |
| Day 4          | Supervisor or client output required    | Two documents missing                   | Consider whether timing affects priority or escalation. |
| Day 5          | Follow-up action needed                 | Another team member takes over tomorrow | Consider whether timing affects priority or escalation. |
...
>
> **•** For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Key points needed before 4pm; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Client complaint received; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: One deadline uncertain; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Two documents missing; Why timing matters: Consider whether timing affects priority or escalation..
>
> **•** For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Another team member takes over tomorrow; Why timing matters: Consider whether timing affects priority or escalation..
