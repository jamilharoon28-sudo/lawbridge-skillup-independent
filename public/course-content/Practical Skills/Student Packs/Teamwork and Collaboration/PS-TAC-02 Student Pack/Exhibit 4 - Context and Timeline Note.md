...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Launch date fixed because marketing started | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Budget approval depends on supplier pricing | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Data terms and liability unresolved | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Participants across London Manchester Dubai | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Action list has no owners | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Launch date fixed because marketing started; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Budget approval depends on supplier pricing; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Data terms and liability unresolved; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Participants across London Manchester Dubai; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Action list has no owners; Why timing matters: Consider whether timing affects priority or escalation..
