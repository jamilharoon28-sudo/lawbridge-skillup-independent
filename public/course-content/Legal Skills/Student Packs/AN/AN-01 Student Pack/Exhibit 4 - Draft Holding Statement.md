...
**Exhibit 4 - Draft Holding Statement**

**What This Exhibit Contains**

This exhibit contains the source material for 'Draft Holding Statement'. It should be read as a standalone file document and cross-checked against the other exhibits. Key content includes: Date \| 22 July, 10:15 Status \| Draft only We confirm that no client data has been accessed and that the issue was limited to a single mailbox. Our systems are now secure and there is no action for customers to take.
...
We confirm that no client data has been accessed and that the issue was limited to a single mailbox. Our systems are now secure and there is no action for customers to take.

| **Check item**                                          | **Evidence in exhibit** | **Student note** |
|---------------------------------------------------------|-------------------------|------------------|
| Is 'no client data accessed' supported?                 |                         |                  |
| Is 'systems are now secure' too absolute?               |                         |                  |
| Does the draft address uncertainty?                     |                         |                  |
| Should the statement refer to continuing investigation? |                         |                  |
...
> **•** Narrative point: We confirm that no client data has been accessed and that the issue was limited to a single mailbox. Our systems are now secure and there is no action for customers to take.
>
> **•** Source detail: Prepared by is recorded as Marketing Director.
>
> **•** Source detail: Date is recorded as 22 July, 10:15.
>
> **•** Source detail: Status is recorded as Draft only.
>
> **•** The exhibit records Check item: Is 'no client data accessed' supported?.
>
> **•** The exhibit records Check item: Is 'systems are now secure' too absolute?.
>
> **•** The exhibit records Check item: Does the draft address uncertainty?.
>
> **•** The exhibit records Check item: Should the statement refer to continuing investigation?.
