...
| --- | --- | --- | --- |
| Day 1 | Initial instruction received | Schedule 4 listed but not included | Consider whether timing affects priority or escalation. |
| Day 2 | Relevant documents or messages reviewed | Agenda covers obligations and evidence gaps | Consider whether timing affects priority or escalation. |
| Day 3 | Uncertainty identified | Student unsure relevance | Consider whether timing affects priority or escalation. |
| Day 4 | Supervisor or client output required | Supervisor welcomes brief evidence-based questions | Consider whether timing affects priority or escalation. |
| Day 5 | Follow-up action needed | Bad draft says everyone missed something | Consider whether timing affects priority or escalation. |
...
- For Time point 'Day 1', the exhibit records Event: Initial instruction received; File detail: Schedule 4 listed but not included; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 2', the exhibit records Event: Relevant documents or messages reviewed; File detail: Agenda covers obligations and evidence gaps; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 3', the exhibit records Event: Uncertainty identified; File detail: Student unsure relevance; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 4', the exhibit records Event: Supervisor or client output required; File detail: Supervisor welcomes brief evidence-based questions; Why timing matters: Consider whether timing affects priority or escalation..

- For Time point 'Day 5', the exhibit records Event: Follow-up action needed; File detail: Bad draft says everyone missed something; Why timing matters: Consider whether timing affects priority or escalation..
