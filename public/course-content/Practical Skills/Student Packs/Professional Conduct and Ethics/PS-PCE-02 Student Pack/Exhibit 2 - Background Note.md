...
**Client / matter setting:** A university friend asks for a quick legal view on an employer dispute and asks for secrecy because they are embarrassed. The student is not acting for them.
...
## Friend asks for legal view

## Not acting for the friend

## Shared connection at employer

## Draft reply gives unsafe advice

## Must signpost safely

## Protect friendship and boundary

| # | File point | How to treat it | Follow-up required |
| --- | --- | --- | --- |
| 1 | Friend asks for legal view | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2 | Not acting for the friend | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3 | Shared connection at employer | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4 | Draft reply gives unsafe advice | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5 | Must signpost safely | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6 | Protect friendship and boundary | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
- Source detail: Client / matter setting is recorded as A university friend asks for a quick legal view on an employer dispute and asks for secrecy because they are embarrassed. The student is not acting for them..
...
- For # '1', the exhibit records File point: Friend asks for legal view; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '2', the exhibit records File point: Not acting for the friend; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '3', the exhibit records File point: Shared connection at employer; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '4', the exhibit records File point: Draft reply gives unsafe advice; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '5', the exhibit records File point: Must signpost safely; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '6', the exhibit records File point: Protect friendship and boundary; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
