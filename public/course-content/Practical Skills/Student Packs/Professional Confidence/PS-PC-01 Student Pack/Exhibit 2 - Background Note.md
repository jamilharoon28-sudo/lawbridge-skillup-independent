...
**Client / matter setting:** The student notices that Schedule 4 is listed but missing from a bundle. Senior people are in the meeting and the student is nervous but the point may matter.
...
## Schedule 4 listed but not included

## Agenda covers obligations and evidence gaps

### Student unsure relevance

## Supervisor welcomes brief evidence-based questions

## Bad draft says everyone missed something

## Confidence without overclaiming

| # | File point | How to treat it | Follow-up required |
| --- | --- | --- | --- |
| 1 | Schedule 4 listed but not included | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2 | Agenda covers obligations and evidence gaps | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3 | Student unsure relevance | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4 | Supervisor welcomes brief evidence-based questions | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5 | Bad draft says everyone missed something | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6 | Confidence without overclaiming | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
- Source detail: Client / matter setting is recorded as The student notices that Schedule 4 is listed but missing from a bundle. Senior people are in the meeting and the student is nervous but the point may matter..
...
- For # '1', the exhibit records File point: Schedule 4 listed but not included; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '2', the exhibit records File point: Agenda covers obligations and evidence gaps; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '3', the exhibit records File point: Student unsure relevance; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '4', the exhibit records File point: Supervisor welcomes brief evidence-based questions; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '5', the exhibit records File point: Bad draft says everyone missed something; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '6', the exhibit records File point: Confidence without overclaiming; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
