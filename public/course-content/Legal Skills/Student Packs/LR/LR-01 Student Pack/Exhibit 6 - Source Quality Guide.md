...
Source path: `Legal Skills/Student Packs/LR/LR-01 Student Pack/Exhibit 6 - Source Quality Guide.docx`
...
| 👤 | Exhibit number | 6 |
| ◷ | Document title | Source Quality Guide |
...
| --- | --- | --- | --- |
| 1 | Status \| Training note | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 2 | Use official regulator, legislation, court or government sources where available. Do not rely on blogs for final legal propositions. Record date accessed and whether the source is binding, guidance, commentary or practic | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 3 | Which sources are authoritative? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 4 | Which sources are only explanatory? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
| 5 | What must be checked for currency? | This may affect the output, risk ranking, evidence analysis or follow-up questions. | Check whether the point is confirmed elsewhere, disputed, incomplete or requires legal framework verification. |
