...
**Client / matter setting:** Tomas, a founder, is confused by a long email about whether a contract clause stops the company using its own data later. He needs a plain English explanation.
...
## Founder asks practical data-use question

## Clause restricts project materials after termination

## Previous draft uses jargon

## Company wants to reuse anonymised learnings

## Must identify legal verification points

## Avoid patronising tone

| # | File point | How to treat it | Follow-up required |
| --- | --- | --- | --- |
| 1 | Founder asks practical data-use question | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 2 | Clause restricts project materials after termination | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 3 | Previous draft uses jargon | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 4 | Company wants to reuse anonymised learnings | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 5 | Must identify legal verification points | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
| 6 | Avoid patronising tone | Treat as a file point, not a conclusion. | Check against the exhibit set before relying on it. |
...
- Source detail: Client / matter setting is recorded as Tomas, a founder, is confused by a long email about whether a contract clause stops the company using its own data later. He needs a plain English explanation..
...
- For # '1', the exhibit records File point: Founder asks practical data-use question; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '2', the exhibit records File point: Clause restricts project materials after termination; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '3', the exhibit records File point: Previous draft uses jargon; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '4', the exhibit records File point: Company wants to reuse anonymised learnings; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '5', the exhibit records File point: Must identify legal verification points; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..

- For # '6', the exhibit records File point: Avoid patronising tone; How to treat it: Treat as a file point, not a conclusion.; Follow-up required: Check against the exhibit set before relying on it..
