...
**Subject:** PS-PC-02 - Preparing for a Mentor Conversation With Purpose

**Priority:** Medium to high - prepare a practical trainee-style output

## Email body

Please review the attached training file for Preparing for a Mentor Conversation With Purpose. The client or internal team needs a practical output, not an academic essay. Do not assume facts that are not in the exhibits. Do not give a final legal conclusion where the applicable framework or source has not been verified. Your task is to identify the core issue, extract the evidence, flag uncertainty, and produce a clear next step.

Primary skill focus: Professional Confidence.

Matter type: Mentorship and career confidence.

Core scenario: Sara has a 20-minute mentor session with a commercial disputes associate experienced in technology clients. She wants specific, respectful questions.
...
- Narrative point: Please review the attached training file for Preparing for a Mentor Conversation With Purpose. The client or internal team needs a practical output, not an academic essay. Do not assume facts that are not in the exhibits. Do not give a final legal conclusion...

- Narrative point: Primary skill focus: Professional Confidence.

- Narrative point: Matter type: Mentorship and career confidence.

- Narrative point: Core scenario: Sara has a 20-minute mentor session with a commercial disputes associate experienced in technology clients. She wants specific, respectful questions.
...
- Source detail: Subject is recorded as PS-PC-02 - Preparing for a Mentor Conversation With Purpose.
