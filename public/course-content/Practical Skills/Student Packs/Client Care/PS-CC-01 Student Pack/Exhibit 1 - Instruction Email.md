...
- Narrative point: Please review the attached training file for The Client Waiting for an Update. The client or internal team needs a practical output, not an academic essay. Do not assume facts that are not in the exhibits. Do not give a final legal conclusion where the...

- Narrative point: Primary skill focus: Client Care.

- Narrative point: Matter type: Small business service dispute.

- Narrative point: Core scenario: Amira runs a small catering business. She sent documents two weeks ago about a cancelled venue contract and has heard nothing. The venue is chasing her and cash flow is tight.
...
- Source detail: Subject is recorded as PS-CC-01 - The Client Waiting for an Update.
